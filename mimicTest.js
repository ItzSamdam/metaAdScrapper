...
//         this.demoDataDir = null; // path.join(__dirname, 'demo-data');
...
// Comprehensive demo showing ALL implemented features
const { initialSync, incrementalSync, AdStorage, MetaAdScraper } = require('./dist');
const fs = require('fs');
const path = require('path');
...
class DemoRunner {
    ...
    constructor() {
        this.demoPageId = 'demo-page-123';
        // Initialize demoDataDir here with proper path
        this.demoDataDir = path.join(__dirname, 'demo-data');
        ...
        // Now create storage with the properly initialized path
        this.storage = new AdStorage(this.demoDataDir);
        console.log(this.storage.demoDataDir)
    ...
    async demoFeature1_AdStorage() {
        ...
        console.log('Test ads:', JSON.stringify(testAds, null, 2));
        console.log('page_id value:', testAds[0].page_id);
        console.log('this.demoPageId:', this.demoPageId);
